(function () {
  ...
  add(
    new Clothing("plunge_bra_black", "plunge bra", "chest", "#222222", "black"),
  );
  ...
  add(
    new Clothing("tshirt", "t-shirt", "torso", "#6f9be3", "light blue", [
      "torso",
      "chest",
    ]),
  );
  add(
    new Clothing("blouse", "blouse", "torso", "#6f9be3", "light blue", [
      "torso",
      "chest",
    ]),
  );
  add(
    new Clothing("skater_dress", "skater dress", "torso", "#222222", "black", [
      "torso",
      "chest",
      "groin",
      "leg",
  ...
  add(
    new Clothing("slip_dress", "slip dress", "torso", "#7b2d3b", "burgundy", [
      "torso",
      "chest",
      "groin",
      "leg",
  ...
  add(
    new Clothing("suit_jacket", "suit jacket", "torsoOver", "#222222", "black"),
  );
  ...
  add(
    new Clothing("winter_coat", "winter coat", "torsoOver", "#222222", "black"),
  );
  add(
    new Clothing("trousers", "trousers", "leg", "#222222", "black", [
      "leg",
      "groin",
    ]),
  );
  add(
    new Clothing("jeans", "jeans", "leg", "#6b7c93", "blue-grey", [
      "leg",
      "groin",
    ]),
  );
  add(
    new Clothing("cargo", "cargo trousers", "leg", "#222222", "black", [
      "leg",
      "groin",
    ]),
  );
  add(
    new Clothing("skirt", "skirt", "leg", "#222222", "black", ["leg", "groin"]),
  );
  add(
    new Clothing("yoga", "yoga pants", "leg", "#f5a8ff", "pink", [
      "leg",
      "groin",
    ]),
  );
  ...
  add(
    new Clothing("trainer_socks", "trainer socks", "sock", "#ffffff", "white"),
  );
  ...
  add(
    new Clothing("stilettos", "stiletto heels", "foot", "#7b2d3b", "burgundy"),
  );
  ...
  add(
    new Clothing("watch_black", "women's watch", "wrist", "#222222", "black"),
  );
